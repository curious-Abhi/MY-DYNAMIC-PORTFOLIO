  ...
  return (
    <div className="w-full">
      ...
      md:text-[2.2rem] lg:text-[2.8rem] tracking-[2px] mb-4">
        Hey, I'm {user.full_name}
      </h1>
      <h1 className="text-tubeLight-effect overflow-x-hidden text-[1.3rem] 
      sm:text-[1.75rem] md:text-[2.2rem] lg:text-[2.8rem] tracking-[15px]">
        <Typewriter
          words={["COMPUTER SCIENCE ENGINEER" ,"FULLSTACK DEVELOPER", "YOUTUBER"]}
          loop={50}
          cursor
          typeSpeed={70}
          deleteSpeed={50}
      ...
      items-center mt-4 md:mt-8 lg:mt-10">
        ...
        <Link to={user.facebook_url} target="_blank">
      ...
      <div className="mt-4 md:mt-8 lg:mt-10  flex gap-3">
        ...
        <Link to={user.resume && user.resume_url} target="_blank">
          <Button className="rounded-[30px] flex items-center gap-2 flex-row">
            <span>
              <ExternalLink />
            </span>
      ...
      <p className="mt-8 text-xl tracking-[2px]">{user.about_me}</p>
